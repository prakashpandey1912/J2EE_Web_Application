...
{
found=true;
System.out.println("already email id register");
ErrorBean errorBean=new ErrorBean();
errorBean.setError("EmailID already exists");
...
randomAccessFile.writeBytes(fn+'\n');
randomAccessFile.writeBytes(ln+'\n');
randomAccessFile.writeBytes(eid+'\n');
randomAccessFile.writeBytes(pass+'\n');
